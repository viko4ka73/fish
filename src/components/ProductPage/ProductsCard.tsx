    ...
    return (
        <div className="w-full z-[1]">
            <Link
                ...
                to={slugName}
            >
                <img className="w-[375px] h-[375px] max-xl:w-full max-md:w-full max-md:h-[200px] object-cover object-center rounded-lg"
                 src={`${process.env.REACT_APP_VAR_API_URL}/${photos[0]}`} alt="product image" />
            </Link>
            <div className="pt-5">
                <Link
                    key={name}
