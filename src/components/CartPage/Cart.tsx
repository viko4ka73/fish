                            ...
                            <div className="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start ">
                                ...
                                <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                                    <div className="mt-5 sm:mt-0">
                                        <h2 className="text-lg font-bold  font-montserrat text-extradark-blue">{item.name}</h2>
                                    </div>
                                    <div className="mt-4 flex justify-between im sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                                        <div className="flex items-center border-gray-100">
                                            ...
                                            <input
                                                ...
                                                type="text" value={item.quantity.toFixed(1)} min="1" />
                                            <span onClick={() => { addToCart(item) }}
                                             ...
                                             <span className="text-md ml-2  font-montserrat text-extradark-blue">к/г</span>
                                        </div>
                                        <div className="flex items-center space-x-4 text-dark-blue">
                                            <p className="text-sm">   {updateCartItemPrice(item).toFixed(2)} ₽</p>
